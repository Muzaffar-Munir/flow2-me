                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 40px;"
                                                                    ...
                                                                    <p class="h3 fw-600"
                                                                        style="padding-top: 0; padding-bottom: 0; font-weight: 600 !important; vertical-align: baseline; font-size: 20px; line-height: 33.6px; margin: 0;"
                                                                        align="left">


                                                                    <h2 style="text-align: center">Password Reset</h2>
                                                                    <span class="span fw-300"
                                                                        style="padding-top: 0; padding-bottom: 0; font-weight: 300 !important; vertical-align: baseline; font-size: 20px; line-height: 33.6px; margin: 0;">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;"
                                                                                    align="left" width="100%"
                                                                                    height="16">
                                                                                    <p>If you have lost your password OR
                                                                                        you want to reset it,Use the
                                                                                        Link below to get started.</p>
                                                                                    <br>
                                                                                    {{-- {{ $user}} --}}
                                                                                    ...
                                                                                    <div class="password">
                                                                                        <button class="button">
                                                                                            {{-- $data->token --}}
                                                                                            <a
                                                                                                href="{{'https://test.Flowers-2me.com.com/reset/'.$user->id}}">
                                                                                                Reset your Password
                                                                                            </a>
                                                                                    ...
                                                                                    <p>
                                                                                        ...
                                                                                        passowrd reset, you can safely
                                                                                        ignore this email.
                                                                                        Only a pesron with access to
